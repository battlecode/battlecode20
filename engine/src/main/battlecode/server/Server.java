...
public strictfp class Server implements Runnable {
    ...
    private Team runMatch(GameInfo currentGame,
        ...
        try {
            loadedMap = GameMapIO.loadMap("maptest", new File("/Users/mnocito/desktop/battlecode20/engine/src/main/battlecode/world/resources"/*options.get("bc.game.map-path")*/));
