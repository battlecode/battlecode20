...
public final class Round extends Table {
  ...
  public ByteBuffer teamVictoryPointsInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 8, 4); }
  /**
   ...
   */
  public int dirtChangedBodyIDs(int j) { int o = __offset(24); return o != 0 ? bb.getInt(__vector(o) + j * 4) : 0; }
  public int dirtChangedBodyIDsLength() { int o = __offset(24); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer dirtChangedBodyIDsAsByteBuffer() { return __vector_as_bytebuffer(24, 4); }
  public ByteBuffer dirtChangedBodyIDsInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 24, 4); }
  /**
   * The amount the dirt changed by.
   */
  public int dirtChangesBody(int j) { int o = __offset(26); return o != 0 ? bb.getInt(__vector(o) + j * 4) : 0; }
  public int dirtChangesBodyLength() { int o = __offset(26); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer dirtChangesBodyAsByteBuffer() { return __vector_as_bytebuffer(26, 4); }
  public ByteBuffer dirtChangesBodyInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 26, 4); }
  /**
   * The indexes of the tiles whose dirt amount changed.
   */
  public int dirtChangedIdxs(int j) { int o = __offset(28); return o != 0 ? bb.getInt(__vector(o) + j * 4) : 0; }
  public int dirtChangedIdxsLength() { int o = __offset(28); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer dirtChangedIdxsAsByteBuffer() { return __vector_as_bytebuffer(28, 4); }
  public ByteBuffer dirtChangedIdxsInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 28, 4); }
  /**
   * The amount the dirt changed by.
   */
  public int dirtChanges(int j) { int o = __offset(30); return o != 0 ? bb.getInt(__vector(o) + j * 4) : 0; }
  public int dirtChangesLength() { int o = __offset(30); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer dirtChangesAsByteBuffer() { return __vector_as_bytebuffer(30, 4); }
  public ByteBuffer dirtChangesInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 30, 4); }
  /**
   * The indexes of the tiles whose water amount changed.
   */
  public int waterChangedIdxs(int j) { int o = __offset(32); return o != 0 ? bb.getInt(__vector(o) + j * 4) : 0; }
  public int waterChangedIdxsLength() { int o = __offset(32); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer waterChangedIdxsAsByteBuffer() { return __vector_as_bytebuffer(32, 4); }
  public ByteBuffer waterChangedIdxsInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 32, 4); }
  /**
   * The amount the water changed by.
   */
  public int waterChanges(int j) { int o = __offset(34); return o != 0 ? bb.getInt(__vector(o) + j * 4) : 0; }
  public int waterChangesLength() { int o = __offset(34); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer waterChangesAsByteBuffer() { return __vector_as_bytebuffer(34, 4); }
  public ByteBuffer waterChangesInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 34, 4); }
  /**
   * The indexes of the tiles whose pollution amount changed.
   */
  public int pollutionChangedIdxs(int j) { int o = __offset(36); return o != 0 ? bb.getInt(__vector(o) + j * 4) : 0; }
  public int pollutionChangedIdxsLength() { int o = __offset(36); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer pollutionChangedIdxsAsByteBuffer() { return __vector_as_bytebuffer(36, 4); }
  public ByteBuffer pollutionChangedIdxsInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 36, 4); }
  /**
   * The amount the pollution changed by.
   */
  public int pollutionChanges(int j) { int o = __offset(38); return o != 0 ? bb.getInt(__vector(o) + j * 4) : 0; }
  public int pollutionChangesLength() { int o = __offset(38); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer pollutionChangesAsByteBuffer() { return __vector_as_bytebuffer(38, 4); }
  public ByteBuffer pollutionChangesInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 38, 4); }
  /**
   * The indexes of the tiles whose soup amount changed.
   */
  public int soupChangedIdxs(int j) { int o = __offset(40); return o != 0 ? bb.getInt(__vector(o) + j * 4) : 0; }
  public int soupChangedIdxsLength() { int o = __offset(40); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer soupChangedIdxsAsByteBuffer() { return __vector_as_bytebuffer(40, 4); }
  public ByteBuffer soupChangedIdxsInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 40, 4); }
  /**
   * The amount the soup changed by.
   */
  public int soupChanges(int j) { int o = __offset(42); return o != 0 ? bb.getInt(__vector(o) + j * 4) : 0; }
  public int soupChangesLength() { int o = __offset(42); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer soupChangesAsByteBuffer() { return __vector_as_bytebuffer(42, 4); }
  public ByteBuffer soupChangesInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 42, 4); }
  /**
  ...
  public VecTable indicatorDotLocs(VecTable obj) { int o = __offset(46); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  /**
   * The RGB values of the indicator dots
   */
  public RGBTable indicatorDotRGBs() { return indicatorDotRGBs(new RGBTable()); }
  public RGBTable indicatorDotRGBs(RGBTable obj) { int o = __offset(48); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  /**
  ...
  public VecTable indicatorLineStartLocs(VecTable obj) { int o = __offset(52); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  /**
   * The end location of the indicator lines
   */
  public VecTable indicatorLineEndLocs() { return indicatorLineEndLocs(new VecTable()); }
  public VecTable indicatorLineEndLocs(VecTable obj) { int o = __offset(54); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  /**
   * The RGB values of the indicator lines
   */
  public RGBTable indicatorLineRGBs() { return indicatorLineRGBs(new RGBTable()); }
  public RGBTable indicatorLineRGBs(RGBTable obj) { int o = __offset(56); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  /**
  ...
  public static void addDirtChangedBodyIDs(FlatBufferBuilder builder, int dirtChangedBodyIDsOffset) { builder.addOffset(10, dirtChangedBodyIDsOffset, 0); }
  ...
  public static void addDirtChangesBody(FlatBufferBuilder builder, int dirtChangesBodyOffset) { builder.addOffset(11, dirtChangesBodyOffset, 0); }
  ...
  public static void addDirtChangedIdxs(FlatBufferBuilder builder, int dirtChangedIdxsOffset) { builder.addOffset(12, dirtChangedIdxsOffset, 0); }
  ...
  public static void addDirtChanges(FlatBufferBuilder builder, int dirtChangesOffset) { builder.addOffset(13, dirtChangesOffset, 0); }
  ...
  public static void addWaterChangedIdxs(FlatBufferBuilder builder, int waterChangedIdxsOffset) { builder.addOffset(14, waterChangedIdxsOffset, 0); }
  ...
  public static void addWaterChanges(FlatBufferBuilder builder, int waterChangesOffset) { builder.addOffset(15, waterChangesOffset, 0); }
  ...
  public static void addPollutionChangedIdxs(FlatBufferBuilder builder, int pollutionChangedIdxsOffset) { builder.addOffset(16, pollutionChangedIdxsOffset, 0); }
  ...
  public static void addPollutionChanges(FlatBufferBuilder builder, int pollutionChangesOffset) { builder.addOffset(17, pollutionChangesOffset, 0); }
  ...
  public static void addSoupChangedIdxs(FlatBufferBuilder builder, int soupChangedIdxsOffset) { builder.addOffset(18, soupChangedIdxsOffset, 0); }
  ...
  public static void addSoupChanges(FlatBufferBuilder builder, int soupChangesOffset) { builder.addOffset(19, soupChangesOffset, 0); }
