...
public class MessageSender {
	...
	public void sendScoutSawEnemy(MapLocation loc) {
		Message m = new Message ();
		m.ints = new int[3];
		m.ints[0] = messageTypeScoutSawEnemy;
		m.locations = new MapLocation [2];
		m.locations[1] = loc;
		send(m);
	}

	public void sendStopCamping() {
		Message m = new Message();
		m.ints = new int[3];
		m.ints[0] = messageTypeStopCamping;
		m.locations = new MapLocation [1];
		send(m);
	}
