...
public class Technology{
	...
	public static void achieveTech(RobotType robottype,RobotController rc) throws GameActionException {
		if(robottype==null)
			return;
		...
		if(rc.getRobotTypeCount(desiredBuilding)>0){//tech already achieved
			...
			achieveTech(desiredBuilding.dependency1,rc);
			achieveTech(desiredBuilding.dependency2,rc);
