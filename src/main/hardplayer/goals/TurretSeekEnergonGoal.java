...
public class TurretSeekEnergonGoal extends Goal
{
	MapLocation archonPosition;

	double undeployedMoveDelayTimesUpkeep;
	double deployedMoveDelayTimesUpkeep;
	
	public int getMaxPriority() { return SEEK_ENERGON_PRIORITY; }

	public TurretSeekEnergonGoal(BasePlayer bp)
	{
		super(bp);
