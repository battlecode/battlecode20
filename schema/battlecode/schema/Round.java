...
public final class Round extends Table {
   ...
   */
  public int dirtChangedBodyIDs(int j) { int o = __offset(22); return o != 0 ? bb.getInt(__vector(o) + j * 4) : 0; }
  public int dirtChangedBodyIDsLength() { int o = __offset(22); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer dirtChangedBodyIDsAsByteBuffer() { return __vector_as_bytebuffer(22, 4); }
  public ByteBuffer dirtChangedBodyIDsInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 22, 4); }
  /**
   * The amount the dirt changed by.
   */
  public int dirtChangesBody(int j) { int o = __offset(24); return o != 0 ? bb.getInt(__vector(o) + j * 4) : 0; }
  public int dirtChangesBodyLength() { int o = __offset(24); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer dirtChangesBodyAsByteBuffer() { return __vector_as_bytebuffer(24, 4); }
  public ByteBuffer dirtChangesBodyInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 24, 4); }
  /**
  ...
  public VecTable dirtChangedLocs(VecTable obj) { int o = __offset(26); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  /**
   * The amount the dirt changed by.
   */
  public int dirtChanges(int j) { int o = __offset(28); return o != 0 ? bb.getInt(__vector(o) + j * 4) : 0; }
  public int dirtChangesLength() { int o = __offset(28); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer dirtChangesAsByteBuffer() { return __vector_as_bytebuffer(28, 4); }
  public ByteBuffer dirtChangesInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 28, 4); }
  /**
  ...
  public VecTable waterChangedLocs(VecTable obj) { int o = __offset(30); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  /**
   * The amount the water changed by.
   */
  public int waterChanges(int j) { int o = __offset(32); return o != 0 ? bb.getInt(__vector(o) + j * 4) : 0; }
  public int waterChangesLength() { int o = __offset(32); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer waterChangesAsByteBuffer() { return __vector_as_bytebuffer(32, 4); }
  public ByteBuffer waterChangesInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 32, 4); }
  /**
  ...
  public VecTable pollutionChangedLocs(VecTable obj) { int o = __offset(34); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  /**
   * The amount the pollution changed by.
   */
  public int pollutionChanges(int j) { int o = __offset(36); return o != 0 ? bb.getInt(__vector(o) + j * 4) : 0; }
  public int pollutionChangesLength() { int o = __offset(36); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer pollutionChangesAsByteBuffer() { return __vector_as_bytebuffer(36, 4); }
  public ByteBuffer pollutionChangesInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 36, 4); }
  /**
  ...
  public VecTable soupChangedLocs(VecTable obj) { int o = __offset(38); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  /**
   * The amount the soup changed by.
   */
  public int soupChanges(int j) { int o = __offset(40); return o != 0 ? bb.getInt(__vector(o) + j * 4) : 0; }
  public int soupChangesLength() { int o = __offset(40); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer soupChangesAsByteBuffer() { return __vector_as_bytebuffer(40, 4); }
  public ByteBuffer soupChangesInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 40, 4); }
  /**
   * Costs of new message requests.
   */
  public int newMessagesCosts(int j) { int o = __offset(42); return o != 0 ? bb.getInt(__vector(o) + j * 4) : 0; }
  public int newMessagesCostsLength() { int o = __offset(42); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer newMessagesCostsAsByteBuffer() { return __vector_as_bytebuffer(42, 4); }
  public ByteBuffer newMessagesCostsInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 42, 4); }
  /**
   * New message requests.
   */
  public String newMessages(int j) { int o = __offset(44); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int newMessagesLength() { int o = __offset(44); return o != 0 ? __vector_len(o) : 0; }
  /**
   * Costs of broadcasted messages.
   */
  public int broadcastedMessagesCosts(int j) { int o = __offset(46); return o != 0 ? bb.getInt(__vector(o) + j * 4) : 0; }
  public int broadcastedMessagesCostsLength() { int o = __offset(46); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer broadcastedMessagesCostsAsByteBuffer() { return __vector_as_bytebuffer(46, 4); }
  public ByteBuffer broadcastedMessagesCostsInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 46, 4); }
  /**
   * Broadcasted messages.
   */
  public String broadcastedMessages(int j) { int o = __offset(48); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int broadcastedMessagesLength() { int o = __offset(48); return o != 0 ? __vector_len(o) : 0; }
  /**
   * The IDs of bodies that set indicator dots
   */
  public int indicatorDotIDs(int j) { int o = __offset(50); return o != 0 ? bb.getInt(__vector(o) + j * 4) : 0; }
  public int indicatorDotIDsLength() { int o = __offset(50); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer indicatorDotIDsAsByteBuffer() { return __vector_as_bytebuffer(50, 4); }
  public ByteBuffer indicatorDotIDsInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 50, 4); }
  /**
   * The location of the indicator dots
   */
  public VecTable indicatorDotLocs() { return indicatorDotLocs(new VecTable()); }
  public VecTable indicatorDotLocs(VecTable obj) { int o = __offset(52); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  /**
   * The RGB values of the indicator dots
   */
  public RGBTable indicatorDotRGBs() { return indicatorDotRGBs(new RGBTable()); }
  public RGBTable indicatorDotRGBs(RGBTable obj) { int o = __offset(54); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  /**
   * The IDs of bodies that set indicator lines
   */
  public int indicatorLineIDs(int j) { int o = __offset(56); return o != 0 ? bb.getInt(__vector(o) + j * 4) : 0; }
  public int indicatorLineIDsLength() { int o = __offset(56); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer indicatorLineIDsAsByteBuffer() { return __vector_as_bytebuffer(56, 4); }
  public ByteBuffer indicatorLineIDsInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 56, 4); }
  /**
  ...
  public VecTable indicatorLineStartLocs(VecTable obj) { int o = __offset(58); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  /**
   * The end location of the indicator lines
   */
  public VecTable indicatorLineEndLocs() { return indicatorLineEndLocs(new VecTable()); }
  public VecTable indicatorLineEndLocs(VecTable obj) { int o = __offset(60); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  /**
   * The RGB values of the indicator lines
   */
  public RGBTable indicatorLineRGBs() { return indicatorLineRGBs(new RGBTable()); }
  public RGBTable indicatorLineRGBs(RGBTable obj) { int o = __offset(62); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  /**
   ...
   */
  public String logs() { int o = __offset(64); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer logsAsByteBuffer() { return __vector_as_bytebuffer(64, 1); }
  public ByteBuffer logsInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 64, 1); }
  /**
   * The first sent Round in a match should have index 1. (The starting state,
   * created by the MatchHeader, can be thought to have index 0.)
   * It should increase by one for each following round.
   */
  public int roundID() { int o = __offset(66); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * The IDs of player bodies.
   */
  public int bytecodeIDs(int j) { int o = __offset(68); return o != 0 ? bb.getInt(__vector(o) + j * 4) : 0; }
  public int bytecodeIDsLength() { int o = __offset(68); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer bytecodeIDsAsByteBuffer() { return __vector_as_bytebuffer(68, 4); }
  public ByteBuffer bytecodeIDsInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 68, 4); }
  /**
   * The bytecodes used by the player bodies.
   */
  public int bytecodesUsed(int j) { int o = __offset(70); return o != 0 ? bb.getInt(__vector(o) + j * 4) : 0; }
  public int bytecodesUsedLength() { int o = __offset(70); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer bytecodesUsedAsByteBuffer() { return __vector_as_bytebuffer(70, 4); }
  public ByteBuffer bytecodesUsedInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 70, 4); }
  ...
  public static void startRound(FlatBufferBuilder builder) { builder.startObject(34); }
  ...
  public static void addDirtChangedBodyIDs(FlatBufferBuilder builder, int dirtChangedBodyIDsOffset) { builder.addOffset(9, dirtChangedBodyIDsOffset, 0); }
  ...
  public static void addDirtChangesBody(FlatBufferBuilder builder, int dirtChangesBodyOffset) { builder.addOffset(10, dirtChangesBodyOffset, 0); }
  ...
  public static void addDirtChangedLocs(FlatBufferBuilder builder, int dirtChangedLocsOffset) { builder.addOffset(11, dirtChangedLocsOffset, 0); }
  public static void addDirtChanges(FlatBufferBuilder builder, int dirtChangesOffset) { builder.addOffset(12, dirtChangesOffset, 0); }
  ...
  public static void addWaterChangedLocs(FlatBufferBuilder builder, int waterChangedLocsOffset) { builder.addOffset(13, waterChangedLocsOffset, 0); }
  public static void addWaterChanges(FlatBufferBuilder builder, int waterChangesOffset) { builder.addOffset(14, waterChangesOffset, 0); }
  ...
  public static void addPollutionChangedLocs(FlatBufferBuilder builder, int pollutionChangedLocsOffset) { builder.addOffset(15, pollutionChangedLocsOffset, 0); }
  public static void addPollutionChanges(FlatBufferBuilder builder, int pollutionChangesOffset) { builder.addOffset(16, pollutionChangesOffset, 0); }
  ...
  public static void addSoupChangedLocs(FlatBufferBuilder builder, int soupChangedLocsOffset) { builder.addOffset(17, soupChangedLocsOffset, 0); }
  public static void addSoupChanges(FlatBufferBuilder builder, int soupChangesOffset) { builder.addOffset(18, soupChangesOffset, 0); }
  ...
  public static void addNewMessagesCosts(FlatBufferBuilder builder, int newMessagesCostsOffset) { builder.addOffset(19, newMessagesCostsOffset, 0); }
  ...
  public static void addNewMessages(FlatBufferBuilder builder, int newMessagesOffset) { builder.addOffset(20, newMessagesOffset, 0); }
  ...
  public static void addBroadcastedMessagesCosts(FlatBufferBuilder builder, int broadcastedMessagesCostsOffset) { builder.addOffset(21, broadcastedMessagesCostsOffset, 0); }
  ...
  public static void addBroadcastedMessages(FlatBufferBuilder builder, int broadcastedMessagesOffset) { builder.addOffset(22, broadcastedMessagesOffset, 0); }
  ...
  public static void addIndicatorDotIDs(FlatBufferBuilder builder, int indicatorDotIDsOffset) { builder.addOffset(23, indicatorDotIDsOffset, 0); }
  ...
  public static void addIndicatorDotLocs(FlatBufferBuilder builder, int indicatorDotLocsOffset) { builder.addOffset(24, indicatorDotLocsOffset, 0); }
  public static void addIndicatorDotRGBs(FlatBufferBuilder builder, int indicatorDotRGBsOffset) { builder.addOffset(25, indicatorDotRGBsOffset, 0); }
  public static void addIndicatorLineIDs(FlatBufferBuilder builder, int indicatorLineIDsOffset) { builder.addOffset(26, indicatorLineIDsOffset, 0); }
  ...
  public static void addIndicatorLineStartLocs(FlatBufferBuilder builder, int indicatorLineStartLocsOffset) { builder.addOffset(27, indicatorLineStartLocsOffset, 0); }
  public static void addIndicatorLineEndLocs(FlatBufferBuilder builder, int indicatorLineEndLocsOffset) { builder.addOffset(28, indicatorLineEndLocsOffset, 0); }
  public static void addIndicatorLineRGBs(FlatBufferBuilder builder, int indicatorLineRGBsOffset) { builder.addOffset(29, indicatorLineRGBsOffset, 0); }
  public static void addLogs(FlatBufferBuilder builder, int logsOffset) { builder.addOffset(30, logsOffset, 0); }
  public static void addRoundID(FlatBufferBuilder builder, int roundID) { builder.addInt(31, roundID, 0); }
  public static void addBytecodeIDs(FlatBufferBuilder builder, int bytecodeIDsOffset) { builder.addOffset(32, bytecodeIDsOffset, 0); }
  ...
  public static void addBytecodesUsed(FlatBufferBuilder builder, int bytecodesUsedOffset) { builder.addOffset(33, bytecodesUsedOffset, 0); }
