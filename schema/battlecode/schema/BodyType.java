...
public final class BodyType {
   ...
   */
  public static final byte LANDSCAPER = 1;
  /**
   * Drones pick up any unit and drop them somewhere else.
   */
  public static final byte DRONE = 2;
  /**
   * Net guns shoot down drones.
   */
  public static final byte NET_GUN = 3;
  /**
   * Cows produce pollution.
   */
  public static final byte COW = 4;
  /**
   * Refineries turn crude soup into refined soup, and produce pollution.
   */
  public static final byte REFINERY = 5;
  /**
   * Vaporators reduce pollution.
   */
  public static final byte VAPORATOR = 6;
  /**
   * The hq produces miners, is also a net gun and a refinery.
   */
  public static final byte HQ = 7;
  /**
   * Design schools create landscapers.
   */
  public static final byte DESIGN_SCHOOL = 8;
  /**
   * Fulfillment centers create drones.
   */
  public static final byte FULFILLMENT_CENTER = 9;

  public static final String[] names = { "MINER", "LANDSCAPER", "DRONE", "NET_GUN", "COW", "REFINERY", "VAPORATOR", "HQ", "DESIGN_SCHOOL", "FULFILLMENT_CENTER", };
