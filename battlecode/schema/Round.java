...
public final class Round extends Table {
  ...
  public Vec movedLocs(Vec obj, int j) { int o = __offset(6); return o != 0 ? obj.__init(__vector(o) + j * 8, bb) : null; }
  public int movedLocsLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  /**
   * New bodies.
   */
  public SpawnedBody spawned(int j) { return spawned(new SpawnedBody(), j); }
  public SpawnedBody spawned(SpawnedBody obj, int j) { int o = __offset(8); return o != 0 ? obj.__init(__indirect(__vector(o) + j * 4), bb) : null; }
  public int spawnedLength() { int o = __offset(8); return o != 0 ? __vector_len(o) : 0; }
  /**
  ...
  public static void startRound(FlatBufferBuilder builder) { builder.startObject(9); }
